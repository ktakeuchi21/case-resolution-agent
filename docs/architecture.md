...
The demo advances a labeled September 2026 clock explicitly. Durable timers survive restart, but this web release does not claim an always-running background worker or wall-clock SLA service. All effects and receipts remain deterministic simulations. Render/Supabase is the prepared target; hosted compatibility and deployment remain pending authenticated account selection.
