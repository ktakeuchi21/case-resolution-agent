...
Capacity remains three uploads/session, 1 MB/file, 60 entries/conversation and 150 write attempts/session. The owner approved 128 total reserved workspaces on September 10, 2026, increased from the exhausted 64-workspace limit. Immutable history is not erased to replenish capacity. The portfolio owner must approve any subsequent bounded capacity or retention/rotation change when that deployment fills.
