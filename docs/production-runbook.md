...
## September 11 chat control removal

Revision `ef4f0008e81a6686e0434d336e544c82c41f06d5` is Live on both services: backend deployment `dep-dai2cf6743jc73dlgca0` and static deployment `dep-dai2cihijrss738cs9j0`. The Regenerate, Helpful and Not helpful row and its spacing are removed from every chat answer. Verification includes 89 core tests, 26 local fixture browser checks, type checking, build, hygiene, [backend health/asset parity](../artifacts/conversation/public-smoke-eaeb501e9f7affa4c544b4e2d1b56e42ab5397be26231f57b4fa05c9d619af91.json), and [19 CDN checks](../artifacts/mvp/static-assets-a7d2ada0d2cb01f0553f272b0b7d28f80ddf1525edaa841f2f14b585ec5abc60.json). An isolated public browser verified landing and direct workspace entry without exceptions, with analytics excluded and no model requests. Existing chat history, server APIs, Free plans and caps are preserved.
